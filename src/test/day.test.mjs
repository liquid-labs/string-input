...
describe('Day', () => {
  const validInput = [
    ...
    [
      '2 Jan 2024',
      { validateInput : (input) => input.endsWith('2024') },
      2024,
      1,
      2,
    ],
  ...
  const failureInput = [
    ...
    [
      '2 Jan 2024',
      { max : '1 Jan 2024' },
      "must be less than or equal to '2024-01-01'",
    ],
    [
      '2 Jan 2024',
    ...
    [
      '2 Jan 2024',
      { min : '3 Jan 2024' },
      "must be greater than or equal to '2024-01-03'",
    ],
    [
      '2 Jan 2024',
      { min : new Date(2024, 0, 3) },
      "must be greater than or equal to '2024-01-03'",
    ],
    [
      '2 Jan 2024',
      { min : new Date(2024, 0, 3).getTime() },
      "must be greater than or equal to '2024-01-03'",
    ],
    [
      '2 Jan 2024',
    ...
    [
      '2 Jan 2024',
      { max : /invalid type/ },
      "constraint 'max'.*?has nonconvertible type",
    ],
    ['2 Jan 2024', { min : 'foo' }, "constraint 'min'.*? not recognized"],
    [
      '2 Jan 2024',
      { min : /invalid type/ },
      "constraint 'min'.*?has nonconvertible type",
    ],
    [
      '2 Jan 2024',
      { validateInput : (input) => input.endsWith('2023') },
