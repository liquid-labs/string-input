...
### `BooleanString(input, options)` ⇒ `boolean` <sup>↱<sup>[source code](./src/boolean-string.mjs#L26)</sup></sup> <sup>⇧<sup>[global function index](#global-function-index)</sup></sup>
...
<a id="CardNumber"></a>
### `CardNumber(input, options)` ⇒ `string` <sup>↱<sup>[source code](./src/card-number.mjs#L28)</sup></sup> <sup>⇧<sup>[global function index](#global-function-index)</sup></sup>
...
<a id="DateTime"></a>
### `DateTime(input, options)` ⇒ [`DateTimeData`](#DateTimeData) <sup>↱<sup>[source code](./src/date-time.mjs#L57)</sup></sup> <sup>⇧<sup>[global function index](#global-function-index)</sup></sup>
...
<a id="EIN"></a>
### `EIN(input, options)` ⇒ `string` <sup>↱<sup>[source code](./src/ein.mjs#L19)</sup></sup> <sup>⇧<sup>[global function index](#global-function-index)</sup></sup>
...
<a id="Email"></a>
### `Email(input, options)` ⇒ [`EmailData`](#EmailData) <sup>↱<sup>[source code](./src/email.mjs#L104)</sup></sup> <sup>⇧<sup>[global function index](#global-function-index)</sup></sup>
...
### `getLatestTLDs()` ⇒ `Promise.<object>` <sup>↱<sup>[source code](./src/email.mjs#L146)</sup></sup> <sup>⇧<sup>[global function index](#global-function-index)</sup></sup>
...
<a id="Integer"></a>
### `Integer(input, options)` ⇒ `number` <sup>↱<sup>[source code](./src/integer.mjs#L27)</sup></sup> <sup>⇧<sup>[global function index](#global-function-index)</sup></sup>
...
<a id="Numeric"></a>
### `Numeric(input, options)` ⇒ `number` <sup>↱<sup>[source code](./src/numeric.mjs#L25)</sup></sup> <sup>⇧<sup>[global function index](#global-function-index)</sup></sup>
...
<a id="SSN"></a>
### `SSN(input, options)` ⇒ `string` <sup>↱<sup>[source code](./src/ssn.mjs#L19)</sup></sup> <sup>⇧<sup>[global function index](#global-function-index)</sup></sup>
...
### `ValidatedString(input, options)` ⇒ `string` <sup>↱<sup>[source code](./src/validated-string.mjs#L26)</sup></sup> <sup>⇧<sup>[global function index](#global-function-index)</sup></sup>
...
<a id="DateTimeData"></a>
### `DateTimeData` : `object` <sup>↱<sup>[source code](./src/date-time.mjs#L14)</sup></sup> <sup>⇧<sup>[global typedef index](#global-typedef-index)</sup></sup>
